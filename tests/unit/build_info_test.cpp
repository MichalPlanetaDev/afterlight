...
int main()
{
    ...
    test.expect(info.semantic_version == "0.14.0-dev",
                "persistent material-parameter version is explicit");

    test.expect(info.milestone == "Persistent Material Parameter Block",
